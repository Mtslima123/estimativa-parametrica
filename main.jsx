...
function generatePDF({ estimate, calc, refProject, apresentacao = DEFAULT_APRESENTACAO }) {
  ...
  const cor2 = ap.corAcento || '#0891b2';
...
function LoginView({ onLogin }) {
  ...
  const css = `
    ...
    .link-btn {
      background: none; border: none;
      font-size: 12px; color: rgba(8,145,178,0.7);
      ...
      <style>{`
        ...
        * { box-sizing: border-box; }
        ...
        .nav-tab::before {
          ...
          position: absolute;
          inset: 0;
          background: radial-gradient(ellipse at 50% 120%, rgba(8,145,178,0.18) 0%, transparent 70%);
          opacity: 0;
        ...
        .nav-tab:not(.active):hover {
          ...
          text-shadow: 0 0 12px rgba(8,145,178,0.35);
        }
        ...
        .nav-tab.active {
          ...
          text-shadow: 0 0 8px rgba(8,145,178,0.25);
        }
        .nav-tab.active svg {
        ...
        .nav-tab:active::before {
          background: radial-gradient(ellipse at 50% 120%, rgba(8,145,178,0.3) 0%, transparent 70%);
          opacity: 1;
        }
      `}</style>
                            ...
                            <div className="flex items-center gap-3">
                              ...
                              <button
                                ...
                                borderRadius:7, boxShadow:'0 1px 2px rgba(13,30,53,0.05)',
                                  borderRadius: 4, cursor: 'pointer', color: '#164e63',
      ...
      <div className="space-y-4">
        ...
        <Card title="Cores">
          <div className="p-4 grid grid-cols-2 gap-4">
            ...
            <button
              onClick={() => { set('corPrimaria', '#1F3864'); set('corAcento', '#0891b2'); }}
...
// ═══════════════════════════════════════════════════════════════════════════
const CHART_COLORS = [
  '#0f172a', '#0891b2', '#0e7490', '#9333ea', '#dc2626',
    ...
    <div style={{ display:'flex', alignItems:'center', gap:8 }}>
      {isOverride && (
        <button onClick={() => onChange(null)}
          style={{ fontSize:11, color:'#164e63', padding:'4px 8px', background:'#ecfeff', border:'1px solid #a5f3fc', borderRadius:4, cursor:'pointer', display:'flex', alignItems:'center', gap:4, fontWeight:500 }}>
      ...
      <input type="number" step="0.01" value={isOverride ? value : ''}
        ...
        style={{
          ...
          background: isOverride ? '#ecfeff' : '#F0FDF4',
          border: `1px solid ${isOverride ? '#a5f3fc' : '#BBF7D0'}`,
          borderRadius:4, outline:'none',
          color: isOverride ? '#164e63' : '#065F46',
        }}
      />
...
function TotalRow({ label, incc, rs, highlight }) {
  return (
    <div style={{
      ...
      background: highlight ? '#ecfeff' : 'transparent',
