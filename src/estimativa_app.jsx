...
import {
  ...
  Calendar, Layers, TrendingUp, Activity, ClipboardList, Home, Settings,
} from 'lucide-react';
...
// ═══════════════════════════════════════════════════════════════════════════
function ModuloEmDesenvolvimento({ nome, icone, descricao, onVoltar }) {
  return (
    <div style={{ minHeight:'100vh', background:'#f0f5fc', fontFamily:'"IBM Plex Sans", sans-serif', display:'flex', flexDirection:'column' }}>
      ...
      {/* topbar */}
      <div style={{ background:'#0d1e35', height:48, display:'flex', alignItems:'center', padding:'0 20px', gap:12, borderBottom:'1px solid rgba(46,111,173,0.25)' }}>
        <button onClick={onVoltar}
          style={{ display:'flex', alignItems:'center', gap:6, fontSize:11, color:'rgba(255,255,255,0.5)', background:'rgba(255,255,255,0.06)', border:'1px solid rgba(255,255,255,0.1)', borderRadius:3, padding:'4px 10px', cursor:'pointer', fontFamily:'"IBM Plex Sans",sans-serif' }}
      ...
      <div style={{ flex:1, display:'flex', alignItems:'center', justifyContent:'center' }}>
        <div style={{ textAlign:'center', maxWidth:360 }}>
          <div style={{ width:64, height:64, background:'#fff', border:'1px solid #ccdaee', borderTop:'3px solid #2e6fad', borderRadius:4, display:'flex', alignItems:'center', justifyContent:'center', fontSize:28, margin:'0 auto 20px' }}>
            {icone}
          </div>
          <div style={{ fontSize:18, fontWeight:600, color:'#0d1e35', marginBottom:8 }}>{nome}</div>
          <div style={{ fontSize:13, color:'#6b7a90', lineHeight:1.6, marginBottom:20 }}>{descricao}</div>
          <div style={{ display:'inline-flex', alignItems:'center', gap:8, padding:'6px 14px', background:'#fef3c7', border:'1px solid #fde68a', borderRadius:3 }}>
            <span style={{ width:7, height:7, borderRadius:'50%', background:'#f59e0b', display:'inline-block' }}></span>
            <span style={{ fontSize:11, fontWeight:600, color:'#92400e', textTransform:'uppercase', letterSpacing:'0.07em', fontFamily:'"IBM Plex Mono",monospace' }}>Em desenvolvimento</span>
          </div>
          <div style={{ marginTop:24 }}>
            <button onClick={onVoltar}
              style={{ fontSize:12, color:'#2e6fad', background:'none', border:'1px solid #ccdaee', borderRadius:3, padding:'7px 16px', cursor:'pointer', fontFamily:'"IBM Plex Sans",sans-serif' }}
...
function HomeView({ authUser, onSelectModulo, onLogout }) {
  ...
  const SL = { fontSize:9, textTransform:'uppercase', letterSpacing:'0.1em', color:'#6b7a90', fontWeight:700, marginBottom:10, display:'flex', alignItems:'center', gap:8 };

  const ModCard = ({ m }) => (
    <div
      onClick={() => m.ativo && onSelectModulo(m.id)}
      style={{
        background:'#fff', border:'1px solid #ccdaee', borderRadius:4,
        padding:'13px 12px 11px', cursor: m.ativo ? 'pointer' : 'default',
        position:'relative', opacity: m.ativo ? 1 : 0.72,
      ...
      <div style={{ position:'fixed', top:0, left:0, width:52, height:'100vh', background:'#0d1e35', display:'flex', flexDirection:'column', alignItems:'center', padding:'14px 0', gap:4, borderRight:'1px solid rgba(46,111,173,0.2)', zIndex:30 }}>
        ...
        {SNAV.map(s => (
          <button key={s.id} title={s.title}
            ...
            style={{ width:36, height:36, borderRadius:4, display:'flex', alignItems:'center', justifyContent:'center', border:'none', background: s.id==='home' ? 'rgba(46,111,173,0.3)' : 'none', color: s.id==='home' ? '#7db8ea' : 'rgba(255,255,255,0.35)', cursor:'pointer', flexShrink:0, transition:'background .15s, color .15s' }}
        ...
        <div style={{ background:'#0d1e35', height:44, display:'flex', alignItems:'center', justifyContent:'space-between', padding:'0 20px', borderBottom:'1px solid rgba(46,111,173,0.25)', position:'sticky', top:0, zIndex:20, flexShrink:0 }}>
          ...
          <div style={{ display:'flex', alignItems:'center', gap:8 }}>
                ...
                <div style={{ position:'absolute', top:34, right:0, width:300, background:'#fff', border:'1px solid #ccdaee', borderRadius:4, boxShadow:'0 4px 20px rgba(13,30,53,0.15)', zIndex:50 }}>
                  ...
                  {NOTIFS.map((n,i) => (
                    <div key={i} style={{ padding:'9px 12px', borderBottom: i < NOTIFS.length-1 ? '1px solid #f0f4f9':'none', display:'flex', alignItems:'flex-start', gap:8, background: n.lida ? '#fff' : '#fafcff' }}>
                      <div style={{ width:6, height:6, borderRadius:'50%', flexShrink:0, marginTop:4, background: n.tipo==='warn'?'#d97706':n.tipo==='danger'?'#b91c1c':n.tipo==='info'?'#2e6fad':'#1a7a4a' }} />
                      <div style={{ flex:1 }}>
            ...
            <div style={{ display:'flex', alignItems:'center', gap:7, borderLeft:'1px solid rgba(255,255,255,0.08)', paddingLeft:10 }}>
              <div style={{ width:26, height:26, borderRadius:'50%', background:'#2e6fad', display:'flex', alignItems:'center', justifyContent:'center', fontSize:9, fontWeight:600, color:'#fff', fontFamily:'"IBM Plex Mono",monospace' }}>
                {initials}
              </div>
        ...
        <div style={{ padding:'18px 20px 32px', flex:1 }}>
          ...
          <div style={{ background:'#fff', border:'1px solid #ccdaee', borderLeft:'4px solid #2e6fad', borderRadius:'0 4px 4px 0', padding:'11px 16px', display:'flex', alignItems:'center', justifyContent:'space-between', marginBottom:14 }}>
            ...
            <div style={{ display:'flex', gap:7 }}>
              {[
                { label:'Nova estimativa', id:'estimativa' },
                { label:'Novo orcamento',  id:'orcamentos' },
                { label:'Nova obra',       id:'obras'      },
              ].map(c => (
                <div key={c.label} onClick={() => onSelectModulo(c.id)}
                  ...
                  <span style={{ fontSize:12, lineHeight:1 }}>+</span> {c.label}
                </div>
              ))}
            </div>
          </div>
                ...
                <div style={{ background:'#fff', border:'1px solid #ccdaee', borderRadius:4, overflow:'hidden' }}>
                  {NOTIFS.map((n,i) => (
                    <div key={i} style={{ padding:'8px 12px', borderBottom: i < NOTIFS.length-1 ? '1px solid #f0f4f9':'none', display:'flex', alignItems:'flex-start', gap:8, background: n.lida ? '#fff' : '#fafcff' }}>
                      <div style={{ width:5, height:5, borderRadius:'50%', flexShrink:0, marginTop:4, background: n.tipo==='warn'?'#d97706':n.tipo==='danger'?'#b91c1c':n.tipo==='info'?'#2e6fad':'#1a7a4a' }} />
                      <div style={{ flex:1 }}>
                        <div style={{ fontSize:11, color:'#0d1e35', lineHeight:1.4, fontWeight: n.lida ? 400 : 500 }}>{n.texto}</div>
          ...
          <div style={{ display:'grid', gridTemplateColumns:'1fr 1fr', gap:8 }}>
            ...
            <div>
              ...
              <div style={{ background:'#fff', border:'1px solid #ccdaee', borderRadius:4, overflow:'hidden' }}>
                {favRow.length === 0 && (
                  <div style={{ padding:'16px 12px', fontSize:11, color:'#9baaba', textAlign:'center' }}>
                    Nenhum favorito. Clique na estrela nos modulos.
                  </div>
                )}
                {favRow.map((m,i) => (
...
export default function EstimativaApp() {
  ...
  const [modulo, setModulo] = useState(null); // null = home
  ...
  if (authLoading) {
    return (
      <div style={{ minHeight:'100vh', background:'#0d1e35', display:'flex', alignItems:'center', justifyContent:'center' }}>
        <div style={{ color:'rgba(255,255,255,0.4)', fontSize:14, fontFamily:'"IBM Plex Mono",monospace' }}>Carregando...</div>
      </div>
    );
  }
  ...
  if (!modulo) {
    return <HomeView authUser={authUser} onSelectModulo={setModulo} onLogout={handleLogout} />;
  }

  if (modulo === 'estimativa') {
    return <EstimativaAppInner authUser={authUser} onVoltar={() => setModulo(null)} />;
  }

  const modulosMeta = {
    obras:         { nome:'Obras',         desc:'Cadastro de obras, equipes, documentos e diário de obra.',         icone:'🏗️' },
    orcamentos:    { nome:'Orçamentos',     desc:'Composições de custo, BDI, revisões e fluxo de aprovações.',      icone:'📄' },
    levantamentos: { nome:'Levantamentos',  desc:'Quantitativos de serviços e memória de cálculo.',                 icone:'📐' },
    planejamento:  { nome:'Planejamento',   desc:'EAP, cronograma físico-financeiro e curva S.',                    icone:'📅' },
    cronograma:    { nome:'Cronograma',     desc:'Gráfico de Gantt, linha de balanço e controle de prazo.',         icone:'📊' },
    controles:     { nome:'Controles',      desc:'Medições, avanço físico-financeiro e análise de desvios.',        icone:'📈' },
    indicadores:   { nome:'Indicadores',    desc:'KPIs, dashboards gerenciais e acompanhamento da obra.',           icone:'🎯' },
  };
  const meta = modulosMeta[modulo] || { nome: modulo, desc: '', icone: '🔧' };
  return <ModuloEmDesenvolvimento nome={meta.nome} icone={meta.icone} descricao={meta.desc} onVoltar={() => setModulo(null)} />;
}

function EstimativaAppInner({ authUser, onVoltar }) {
      ...
      <header style={{ position:'sticky', top:0, zIndex:40, boxShadow:'0 2px 20px rgba(13,30,53,0.4)' }}>
        ...
        <div style={{ background:'#0d1e35', padding:'0 24px', height:50, display:'flex', alignItems:'center', gap:12 }}>
          <div style={{ display:'flex', alignItems:'center', gap:10, flex:1 }}>
            {onVoltar && (
              <button onClick={onVoltar}
                style={{ display:'flex', alignItems:'center', gap:5, fontSize:11, color:'rgba(255,255,255,0.45)', background:'rgba(255,255,255,0.06)', border:'1px solid rgba(255,255,255,0.1)', borderRadius:4, padding:'5px 10px', cursor:'pointer', flexShrink:0, fontFamily:'"IBM Plex Sans",sans-serif' }}
          ...
          <div style={{ display:'flex', alignItems:'center', gap:6 }}>
            ...
            {authUser?.id !== 'local' && (
              <div style={{ display:'flex', alignItems:'center', gap:7, paddingLeft:10, borderLeft:'1px solid rgba(255,255,255,0.08)' }}>
                ...
                <button onClick={async () => { if (onVoltar) { onVoltar(); } else { const sb = await loadSupabase(); await sb?.auth.signOut(); } }}
